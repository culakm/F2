...
public class FragmentB extends Fragment {
    ...
    public static FragmentB newInstance(String position) {
        FragmentB fragment = new FragmentB();
        Bundle args = new Bundle();
        //args.putString(ARG_POSITION, position);
        args.putString(ARG_POSITION, lala);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mParam1 = getArguments().getString(ARG_POSITION);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Toast.makeText(getActivity().getApplicationContext(), "FragmentB vytvoreny ", Toast.LENGTH_SHORT).show();
